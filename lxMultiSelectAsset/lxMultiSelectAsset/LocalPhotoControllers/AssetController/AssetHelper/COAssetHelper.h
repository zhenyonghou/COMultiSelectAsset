...
typedef NS_ENUM(NSInteger, COAssetPhotoSizeType) {
    kAssetPhotoSizeTypeThumbnail    = 0,
    kAssetPhotoSizeTypeScreen,
    kAssetPhotoSizeTypeResolution
};


@interface COAssetHelper : NSObject
